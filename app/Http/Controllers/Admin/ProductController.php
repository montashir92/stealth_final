...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $size = Size::all();
        $color = Color::all();
        return view('admin.product.create', compact('category', 'productCode', 'product', 'size', 'color'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $product->is_upcoming = $request->is_upcoming ?? 0;
    ...
    public function update(Request $request, $id)
    {
        ...
        $product->is_upcoming = $request->is_upcoming;
        $product->short_details = $request->short_details;
        $product->description = $request->description;
    ...
    public function destroy($id)
    {
        ...
        foreach($product->productImage as $image){
            if(!empty($image->files) && file_exists($image->files)){
                unlink($image->files);
            }
            $image->delete();   
        }
