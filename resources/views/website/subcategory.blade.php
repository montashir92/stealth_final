            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 order-1 order-lg-2">
                        ...
                        <div class="shop-product-wrapper pt-34">
                                    ...
                                    <div class="col-lg-7 col-md-6">
                                        <div class="top-bar-left">
                                            ...
                                            <div class="product-amount">
                                                <p>Showing {{$subcategory_wise_product->currentPage() }} - {{$subcategory_wise_product->lastPage() }}  of {{$subcategory_wise_product->count() }} results</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="shop-product-wrap grid row">
                              {{-- {{ dd($category_wise_product) }} --}}
                                @foreach ($subcategory_wise_product as $item)
                                ...
                                <div class="product-list-item mb-30">
                                    ...
                                    <div class="product-list-content">
                                        ...
                                        <div class="product-list-action-link">
                                            ...
                                            <a href="#" data-toggle="modal" onclick="product({{ $item->id }})" data-target="#quick_view"> <span data-toggle="tooltip" data-placement="top" title="Quick view"><i class="fa fa-search"></i></span> </a>
                                        </div>
                                    </div>
                                </div>
                                    <input type="hidden" value="{{ $item->id }}" name="id">
                        ...
                        <div class="paginatoin-area text-center  mb-3 pb-3 pt-28">
                            <div class="row">
                                <div class="col-12">
                                    {{$subcategory_wise_product->links()}} 
