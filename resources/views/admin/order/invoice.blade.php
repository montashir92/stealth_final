        ...
        <div class="col-lg-12">
            <div class="card mb-3 px-2" >
                <div class="card-body " id="printableArea">
                    <div>
                      <h3 style="text-align: right; margin:15px 0px">Invoice &nbsp;&nbsp;#{{ $order->invoice_no }}</h3>
                      <hr class="mt-1 mb-1">
                    </div>
                    <div style="display: flex;">
                      ...
                      <div style="width: 70%;">
                        ...
                        <p style="text-align: right; margin-bottom:0">{{ $order->customer_name }}<br><strong> Billing Address:</strong> {{ $order->billing_address }}</p>
                    ...
                    <div class="">
                          <table style="border-collapse: collapse;width: 100%;">
                            <thead style="background:#000; color:#fff; padding:10px;">
                              <tr >
                    ...
                    <div>
                      ...
                      <h4 style="text-align: right; font-weight:700"><span>Total :</span>  {{ $order->total_amount }} Tk</h4>
                      <hr >
                    </div>
