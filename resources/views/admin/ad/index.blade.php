                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-2">
                                    ...
                                    <select name="position" id="" class="form-control form-control-sm @error('position') is-invalid @enderror">
                                        ...
                                        <option value="1">Left-small-245*320</option>
                                        <option value="3">Center-middle-425*145</option>
                                        <option value="2">Right-small-335*320</option>
                                        <option value="5">Full-Big-785*180</option>
                                        <option value="4">Center-middle-450*150)</option>
                                        <option value="6">Left-small-310*150</option>
                                    </select>
                                    @error('position')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
