                            ...
                            <div class="row">
                               <div class="col-md-6">
                                  <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number"  step="any" name="price" value="{{ old('price') }}" placeholder="Price" class="form-control my-form-control @error('price') is-invalid @enderror">
                                          @error('price')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span> 
                               ...
                               <div class="col-md-6">
                                <div class="row">
                                  ...
                                  <div class="col-md-3 mt-1">
                                   <input type="checkbox" name="is_upcoming" value="1" {{ old('is_upcoming') == '1' ? 'checked' : '' }}  class="@error('is_upcoming') is-invalid @enderror" id="">
                                        @error('is_upcoming')
                                          <span class="invalid-feedback" role="alert">
                                              <strong>{{ $message }}</strong>
                                          </span> 
