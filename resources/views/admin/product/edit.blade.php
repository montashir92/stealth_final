                            ...
                            <div class="row">
                               <div class="col-md-6">
                                  <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="number" step="any" name="price" value="{{ $product->price }}" class="form-control my-form-control @error('price') is-invalid @enderror">
                                            @error('price')
                                              <span class="invalid-feedback" role="alert">
                                                  <strong>{{ $message }}</strong>
                                              </span> 
                               ...
                               <div class="col-md-6">
                                <div class="row">
                                  ...
                                  <div class="col-md-3 mt-1">
                                   <input type="checkbox" name="is_upcoming" @if(old('is_upcoming', $product->is_upcoming)) checked @endif value="1"  class="@error('is_upcoming') is-invalid @enderror" id="">
                                        @error('is_upcoming')
                                          <span class="invalid-feedback" role="alert">
                                              <strong>{{ $message }}</strong>
                                          </span> 
