                     ...
                     <div class="col-md-6">
                         <div class="row">
                            ...
                            <div class="col-md-9">
                             ...
                             <div class="col-md-9">
                                <input type="number" name="phone_1" value="{{$company->phone_1}}" class="form-control @error('phone_1') is-invalid @enderror my-form-control" >
                               @error('phone_1')
                                   <span class="invalid-feedback" role="alert">
                                       <strong>{{$message}}</strong>
                                   </span>
                            ...
                            <!-- </div> -->
                             ...
                             <div class="col-md-9">
                                <input type="number" name="phone_2" value="{{$company->phone_2}}"  class="form-control @error('phone_2') is-invalid @enderror my-form-control" >
                             </div> 
                              @error('phone_2')
                                   <span class="invalid-feedback" role="alert">
                                       <strong>{{$message}}</strong>
                             ...
                             <div class="col-md-3">
                                <strong><label>Office Time</label> <span class="float-right">:</span></strong>
                            </div>
                            <div class="col-md-9">
                                <input type="text" name="office_time" value="{{ $company->office_time }}"  class="form-control my-form-control" >
                            </div> 
